...
<!--
<pre>
ICT: <?php echo date('Y-m-d\TH:i:s\Z') ?><br>
...
<form id="payment_form" action="payment_confirm.php" method="post">
    ...
    <input type="hidden" name="signed_field_names" value="profile_id,access_key,transaction_uuid,signed_field_names,unsigned_field_names,signed_date_time,locale,payment_method,transaction_type,reference_number,auth_trans_ref_no,amount,currency,aggregator_id,sales_organization_id,submerchant_id,merchant_descriptor,override_custom_receipt_page">
    ...
    <fieldset>
        ...
        The name of each signed field should be included in the signed_field_names.
            ...
            <h3>Merchant Aggregator Fields</h3>
    ...
    <input type="hidden" name="item_0_name" value="Krungsri Dividend Stock LTF" />
    ...
    <input type="hidden" name="item_1_name" value="Krungsri Dividend Stock LTF 70/30" />
